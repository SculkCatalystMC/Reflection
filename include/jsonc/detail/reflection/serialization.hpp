...
constexpr JsoncType serialize_impl(const T& t, const Options& options, PriorityTag<10>) noexcept;

template <concepts::is_boolean_type T>
constexpr JsoncType serialize_impl(const T& t, const Options& options, PriorityTag<9>) noexcept;
...
constexpr JsoncType serialize_impl(const Renamed<T, N>& t, const Options& options, PriorityTag<8>) noexcept;

template <typename T, FixedString... Args>
constexpr JsoncType serialize_impl(const Annotated<T, Args...>& t, const Options& options, PriorityTag<7>) noexcept;

template <concepts::is_dispatcher T>
constexpr JsoncType serialize_impl(const T& t, const Options& options, PriorityTag<6>) noexcept;

template <concepts::is_optional T>
constexpr JsoncType serialize_impl(const T& t, const Options& options, PriorityTag<6>) noexcept;

template <concepts::is_ranged T>
constexpr JsoncType serialize_impl(const T& t, const Options& options, PriorityTag<5>) noexcept;

template <concepts::is_enum T>
constexpr JsoncType serialize_impl(const T& t, const Options& options, PriorityTag<5>) noexcept;

template <concepts::is_variant T>
constexpr JsoncType serialize_impl(const T& t, const Options& options, PriorityTag<4>) noexcept;

template <concepts::is_string_convertible T>
constexpr JsoncType serialize_impl(const T& t, const Options& options, PriorityTag<3>) noexcept;

template <concepts::is_tuple_like T>
constexpr JsoncType serialize_impl(const T& t, const Options& options, PriorityTag<3>) noexcept;

template <concepts::is_array_like T>
constexpr JsoncType serialize_impl(const T& t, const Options& options, PriorityTag<2>) noexcept;

template <concepts::is_associative T>
constexpr JsoncType serialize_impl(const T& t, const Options& options, PriorityTag<2>) noexcept;

template <concepts::is_aggregate T>
constexpr JsoncType serialize_impl(const T& t, const Options& options, PriorityTag<1>) noexcept;

template <typename T>
constexpr JsoncType serialize_impl(const T& t, const Options& options, PriorityTag<0>) noexcept;
...
template <concepts::is_arithmetic T>
constexpr JsoncType serialize_impl(const T& t, const Options&, PriorityTag<10>) noexcept {
    return t;
}

template <concepts::is_boolean_type T>
constexpr JsoncType serialize_impl(const T& t, const Options&, PriorityTag<9>) noexcept {
...
template <concepts::is_string_convertible T>
constexpr JsoncType serialize_impl(const T& t, const Options&, PriorityTag<3>) noexcept {
...
constexpr JsoncType serialize_impl(const T& t, const Options& options, PriorityTag<2>) noexcept {
    ...
    for (const auto& [key, val] : t) { res[detail::type_to_string(key)] = serialize_impl(val, options, PriorityTag<10>{}); }
    return res;
}
...
template <typename T>
constexpr JsoncType serialize_impl(const T&, const Options&, PriorityTag<0>) noexcept {
