...
constexpr detail::basic_jsonc<O, A> serialize_impl(const T& t, const options& options, F&& kfmt, priority_tag<10>);

template <concepts::is_jsonc_array T, concepts::is_key_formatter F, bool O, bool A>
constexpr detail::basic_jsonc<O, A> serialize_impl(const T& t, const options& options, F&& kfmt, priority_tag<9>);
...
constexpr detail::basic_jsonc<O, A> serialize_impl(const T& t, const options& options, F&& kfmt, priority_tag<8>);

template <concepts::is_annotated T, concepts::is_key_formatter F, bool O, bool A>
constexpr detail::basic_jsonc<O, A> serialize_impl(const T& t, const options& options, F&& kfmt, priority_tag<7>);

template <concepts::is_dispatcher T, concepts::is_key_formatter F, bool O, bool A>
constexpr detail::basic_jsonc<O, A> serialize_impl(const T& t, const options& options, F&& kfmt, priority_tag<6>);
...
constexpr detail::basic_jsonc<O, A> serialize_impl(const T& t, const options& options, F&& kfmt, priority_tag<5>);
...
constexpr detail::basic_jsonc<O, A> serialize_impl(const T& t, const options& options, F&& kfmt, priority_tag<4>);

template <concepts::is_string_convertible T, concepts::is_key_formatter F, bool O, bool A>
constexpr detail::basic_jsonc<O, A> serialize_impl(const T& t, const options& options, F&& kfmt, priority_tag<3>);
...
constexpr detail::basic_jsonc<O, A> serialize_impl(const T& t, const options& options, F&& kfmt, priority_tag<2>);
...
constexpr detail::basic_jsonc<O, A> serialize_impl(const T& t, const options& options, F&& kfmt, priority_tag<1>);

template <typename T, concepts::is_key_formatter F, bool O, bool A>
constexpr detail::basic_jsonc<O, A> serialize_impl(const T& t, const options& options, F&& kfmt, priority_tag<0>);
...
[[nodiscard]] constexpr detail::basic_jsonc<IsOrdered, AllowComments> serialize(const T& t, const options& options = {}) {
    return serialize<IsOrdered, AllowComments>(t, builtin_key_formatter::default_key_formatter, options);
}

template <bool IsOrdered = true, bool AllowComments = true, typename T, concepts::is_key_formatter F>
[[nodiscard]] constexpr detail::basic_jsonc<IsOrdered, AllowComments> serialize(const T& t, F&& key_formatter, const options& options = {}) {
    return serialize_impl<T, F, IsOrdered, AllowComments>(t, options, std::forward<F>(key_formatter), priority_tag<10>{});
}

namespace {

template <reflection::concepts::is_arithmetic T, concepts::is_key_formatter F, bool O, bool A>
constexpr detail::basic_jsonc<O, A> serialize_impl(const T& t, const options&, F&&, priority_tag<10>) {
    return t;
}
...
constexpr detail::basic_jsonc<O, A> serialize_impl(const T& t, const options& options, F&& kfmt, priority_tag<8>) {
    ...
    return serialize_impl<VT, F, O, A>(*t, options, std::forward<F>(kfmt), priority_tag<10>{});
}

template <concepts::is_annotated T, concepts::is_key_formatter F, bool O, bool A>
constexpr detail::basic_jsonc<O, A> serialize_impl(const T& t, const options& options, F&& kfmt, priority_tag<7>) {
    using VT    = std::remove_cvref_t<decltype(*t)>;
    auto result = serialize_impl<VT, F, O, A>(*t, options, std::forward<F>(kfmt), priority_tag<10>{});
    if constexpr (A) {
...
template <reflection::concepts::is_enum T, concepts::is_key_formatter F, bool O, bool A>
constexpr detail::basic_jsonc<O, A> serialize_impl(const T& t, const options& options, F&&, priority_tag<5>) {
...
constexpr detail::basic_jsonc<O, A> serialize_impl(const T& t, const options& options, F&& kfmt, priority_tag<4>) {
    return std::visit(
        [&](const auto& val) {
            ...
            return serialize_impl<VT, F, O, A>(val, options, std::forward<F>(kfmt), priority_tag<10>{});
        },
        t
    );
}
...
template <concepts::is_string_convertible T, concepts::is_key_formatter F, bool O, bool A>
constexpr detail::basic_jsonc<O, A> serialize_impl(const T& t, const options&, F&&, priority_tag<3>) {
...
constexpr detail::basic_jsonc<O, A> serialize_impl(const T& t, const options& options, F&& kfmt, priority_tag<3>) {
    ...
    std::apply(
        [&](const auto&... args) {
            (([&](const auto& val) {
                 using VT = std::remove_cvref_t<decltype(val)>;
                 res.push_back(serialize_impl<VT, F, O, A>(val, options, std::forward<F>(kfmt), priority_tag<10>{}));
             }(args)),
             ...);
        },
        t
...
constexpr detail::basic_jsonc<O, A> serialize_impl(const T& t, const options& options, F&& kfmt, priority_tag<2>) {
    ...
    for (const auto& [key, val] : t) {
        using VT                         = std::remove_cvref_t<decltype(val)>;
        res[detail::type_to_string(key)] = serialize_impl<VT, F, O, A>(val, options, std::forward<F>(kfmt), priority_tag<10>{});
    }
    return res;
}
...
constexpr detail::basic_jsonc<O, A> serialize_impl(const T& t, const options& options, F&& kfmt, priority_tag<1>) {
    ...
    pfr::for_each_field_with_name(t, [&](std::string_view key, const auto& val) {
        ...
        auto res = serialize_impl<VT, F, O, A>(val, options, std::forward<F>(kfmt), priority_tag<10>{});
...
template <typename T, concepts::is_key_formatter F, bool O, bool A>
constexpr detail::basic_jsonc<O, A> serialize_impl(const T&, const options&, F&&, priority_tag<0>) {
