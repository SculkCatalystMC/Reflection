...
struct Config {
    ...
    sculk::reflection::annotated<std::string, "xiwhgasdjjhoikwq">                                     test_2 = "test string with comments";
    sculk::reflection::renamed<sculk::reflection::annotated<std::string, "738whdbhahisdS">, "test-3"> test_3 =
        "test string with renamed key and comments";
    int                                                            test_4  = 232123;
    ...
    std::list<sculk::reflection::annotated<int, "xwsaijnjhiknjk">> test_16 = {1, 2, 3, 4, 5, 6, 7, 8, 9};
    ...
    struct {
        int                                            xxxxx = 123;
        sculk::reflection::annotated<double, "double"> yyyyy = 64738.543;
    } test_23;
